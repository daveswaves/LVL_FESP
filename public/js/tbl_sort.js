...
$(function() {
    $('th').mousedown(function() {
        ...
        // Retrieve appended filename ?param 
        let params = (new Error).fileName.split('?');
        
        // No sort on 1st column if 'disable_sort_col1' is defined
        if ('undefined' !== params[1] && 'disable_sort_col1' == params[1] && 1 == colNumber) {
        // if ('undefined' !== typeof disable_sort_col1 && 1 == colNumber) {
            return false; 
        }
